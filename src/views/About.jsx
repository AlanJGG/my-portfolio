...
export const About = () => {
  return (
    <div id="about" className="min-h-screen p-4 lg:p-28 antialised 2xl:pb-40">
            ...
            <div className="w-full grid gap-y-10 lg:grid-cols-2">
              ...
              <div className="">
                ...
                <ul className="mt-4 ml-5 list-none grid gap-y-2">
                  <li>
                    <TechnologyLabel icon="react.svg" title="React" />
                  </li>
                  <li>
                    <TechnologyLabel icon="nodejs.svg" title="Node" />
                  </li>
                  <li>
                    <TechnologyLabel icon="typescript.svg" title="TypeScript" />
                  </li>
                  <li>
                    <TechnologyLabel icon="mysql.svg" title="MySQL" />
                  </li>
                  <li>
                    <TechnologyLabel icon="mongodb.svg" title="MongoDB" />
                  </li>
                </ul>
              </div>
              <div className="">
