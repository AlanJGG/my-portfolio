  ...
  return (
    <header id="navbar" className="w-full h-[20vh] z-50 relative">
      <nav className="h-full pb-10 flex items-center justify-center relative">
        <ul className="bg-slate-800 bg-opacity-25 p-3 rounded-full shadow-md ease-in-out duration-300 hover:shadow-lg flex lg:gap-x-16 gap-x-2.5 2xl:text-2xl absolute left-1/2 transform -translate-x-1/2">
          <li className="px-2">
            <button
              onClick={() => {
